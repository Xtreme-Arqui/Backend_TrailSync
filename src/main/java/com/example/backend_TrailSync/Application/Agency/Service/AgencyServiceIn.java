package com.example.backend_TrailSync.Application.Agency.Service;
    ...
    public Agency update(Long agencyId, Agency request){
        ...
        return agencyRepository.findById(agencyId).map(agency ->
                        agencyRepository.save(agency.withName(request.getName())
                                ...
                                .withLinkF(request.getLinkF())
                                .withLinkW(request.getLinkW())
                                .withLinkI(request.getLinkI())
                                .withLinkT(request.getLinkT())
                        ))
