package com.example.backend_TrailSync.Application.services.service;
    ...
    public Service update(Long agencyId, Long serviceId, Service service) {
        ...
        return serviceRepository.findById(serviceId).map(existingService ->
                serviceRepository.save(existingService.withName(service.getName())
                        ...
                        .withDifficult(service.getDifficult())
                        .withDistance(service.getDistance())
                        .withAltMax(service.getAltMax())
                        .withAltMin(service.getAltMin())
                        .withTypeRoute(service.getTypeRoute())
                ))
